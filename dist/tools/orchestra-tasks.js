        ...
        try {
            if (args.action === "read" || args.action === "list" || args.action === "validate") {
                ...
                if (args.action === "validate") {
                    ...
                    if (dup.length)
                        return `WARNING duplicate IDs ${[...new Set(dup)].join(",")}`;
            ...
            if (args.action === "append") {
                if (!args.task_json)
                    return "append requires task_json";
                ensureDir();
                let newTasks;
                try {
            ...
            if (args.action === "update-status") {
                if (!args.task_json)
                    return "update-status needs {id,status}";
                let payload;
                try {
...
//# sourceMappingURL=orchestra-tasks.js.map